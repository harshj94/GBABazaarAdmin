...
public class VisibleAdDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visible_ad_details);
        ...
        PermissionManager.with(VisibleAdDetails.this)
    ...
    private class FetchAdDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            csprogress = new ProgressDialog(VisibleAdDetails.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            csprogress.dismiss();
            if (!result) {
                new AlertDialog.Builder(VisibleAdDetails.this)
                ...
                for (i = 0; i < images; i++) {
                    final ImageView imageView = new ImageView(VisibleAdDetails.this);
